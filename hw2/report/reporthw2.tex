...
\begin{document}
	...
	\lstinputlisting[linerange={78-104},firstnumber=78,label={lst:linear},caption={Searching the best value of C in Linear SVM}]{../main.py}
...
%	\lstinputlisting[linerange={109-110},firstnumber=109=label={lst:linear},aboveskip={1pt}]{../main.py}
	...
	\lstinputlisting[linerange={152-152},firstnumber=152,label={lst:rbf1},caption={RBF Kernel SVM Classifier}]{../main.py}
	...
	\lstinputlisting[ linerange={211-227},firstnumber=211,label={lst:rbf2},caption={Searching the best value of C and Gamma in RBF Kernel SVM}]{../main.py}
	...
	\lstinputlisting[ linerange={264-282},firstnumber=264s,label={lst:knn},caption={Validation using k-fold with $k=5$}]{../main.py}
