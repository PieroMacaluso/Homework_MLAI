...
# plot_with_epoch("fig01.png", "Step 1/6 - Old NN", accuracies, losses, n_epochs)
# plot_with_epoch("fig02.png", "Step 2/6 - Simple CNN 32/32/32/64", accuracies, losses, n_epochs)
# plot_with_epoch("fig03a.png", "Step 3/6 - Simple CNN 128/128/128/256", accuracies, losses, n_epochs)
# plot_with_epoch("fig03b.png", "Step 3/6 - Simple CNN 256/256/256/512", accuracies, losses, n_epochs)
# plot_with_epoch("fig03c.png", "Step 3/6 - Simple CNN 512/512/512/1024", accuracies, losses, n_epochs)
# plot_with_epoch("fig04a.png", "Step 4/6 - CNN 128/128/128/256 BN", accuracies, losses, n_epochs)
# plot_with_epoch("fig04b.png", "Step 4/6 - CNN 128/128/128/256 BN + FC1 (8132 neurons)", accuracies, losses, n_epochs)
# plot_with_epoch("fig04c.png", "Step 4/6 - CNN 128/128/128/256 BN + Dropout 0.5 + FC1 (4096)", accuracies, losses,
#                 n_epochs)

# Probably not good
# plot_with_epoch("fig05a.png", "Step 5/6 - CNN 128/128/128/256 BN + D 0.5 + FC1 + Random H Flip", accuracies, losses,
#                 n_epochs)
# plot_with_epoch("fig05b.png", "Step 5/6 - CNN 128/128/128/256 BN + D 0.5 + FC1 + Random Crop", accuracies, losses,
#                 n_epochs)

# plot_with_epoch("fig05aa.png", "Step 5/6 - CNN 128/128/128/256 Random Horizontal Flip", accuracies, losses,
#                 n_epochs)
# plot_with_epoch("fig05bb.png", "Step 5/6 - CNN 128/128/128/256 Random Crop", accuracies, losses,
#                 n_epochs)
plot_with_epoch("fig06.png", "Step 6/6 - ResNet18 pretrained with Random Horizontal Flip", accuracies, losses,
                n_epochs)
