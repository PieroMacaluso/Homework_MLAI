...
\begin{document}
	...
	\lstinputlisting[aboveskip=0pt,linerange={119-131},firstnumber=119,label={lst:oldcnn},caption={Old Neural Network class (\texttt{NN1.py})}]{../NN1.py}
	...
	\lstinputlisting[aboveskip=0pt,linerange={135-154},firstnumber=135,label={lst:simplecnn},caption={Simple Convolutional Neural Network class (\texttt{CNN2.py})}]{../CNN2.py}
	\newpage
	\begin{figure}[ht!]
		\centering
	...
	\lstinputlisting[aboveskip=0pt,linerange={135-154},firstnumber=135,label={lst:cnn3a},caption={Convolutional Neural Network 128/128/128/256 class (\texttt{CNN3a.py})}]{../CNN3a.py}
	\lstinputlisting[linerange={135-154},firstnumber=135,label={lst:cnn3b},caption={Convolutional Neural Network 256/256/256/512 class (\texttt{CNN3b.py})}]{../CNN3b.py}
	\lstinputlisting[linerange={135-154},firstnumber=135,label={lst:cnn3c},caption={Convolutional Neural Network 512/512/512/1024 class (\texttt{CNN3c.py})}]{../CNN3c.py}
	\begin{figure}[ht!]
		\centering
	...
	\lstinputlisting[linerange={135-158},firstnumber=135,label={lst:cnn4a},caption={Convolutional Neural Network with BN (Batch Normalization) (\texttt{CNN4a.py})}]{../CNN4a.py}
	
	\lstinputlisting[linerange={135-158},firstnumber=135,label={lst:cnn4b},caption={Convolutional Neural Network with BN and FC1 wider (\texttt{CNN4b.py})}]{../CNN4b.py}
	\lstinputlisting[linerange={135-159},firstnumber=135,label={lst:cnn4c},caption={Convolutional Neural Network with BN and Dropout $0.5$ on FC1 (\texttt{CNN4c.py})}]{../CNN4c.py}
	...
	\lstinputlisting[aboveskip=1pt, linerange={162-168}, firstnumber=162,label={lst:cnn5a},caption={Random Horizontal Flipping in training data (\texttt{CNN5a.py})}, belowskip=0pt]{../CNN5a.py}
	\lstinputlisting[aboveskip=1pt,linerange={162-168}, firstnumber=162,label={lst:cnn5b},caption={Random Crop on training data (\texttt{CNN5b.py})}]{../CNN5b.py}
...
%	\lstinputlisting[aboveskip=1pt, linerange={29-35}, firstnumber=29,label={lst:cnn5a},caption={Random Horizontal Flipping in training data}, belowskip=0pt]{../CNN5a.py}
%	\lstinputlisting[aboveskip=1pt,linerange={34-40}, firstnumber=34,label={lst:cnn5b},caption={Random Crop on training data}]{../CNN5b.py}
